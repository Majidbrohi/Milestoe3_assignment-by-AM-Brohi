    ...
    <footer className="bg-gradient-to-br from-[#2C3E50] to-[#4C5C68] text-white">
      <div className="container mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="flex space-x-4">
          <Link href="https://github.com/Majidbrohi" aria-label="Facebook">
            <Image
          ...
          <Link href="https://github.com/Majidbrohi" aria-label="Github">
            <Image
          ...
          <Link href="https://www.linkedin.com/in/a-majid-brohi/" aria-label="LinkedIn">
            <Image
              src="/homeres/Lin.png"  
              alt="LinkedIn"
              width={28}
